...
<div class="d-flex align-items-center gap-2 mb-3">
    ...
    <h5 class="mb-0 fw-semibold">Editar torneo</h5>
</div>
            ...
            <div class="row g-3">
                <div class="col-12">
                    ...
                    <input type="text" name="nombre"
                           ...
                           value="{{ old('nombre', $torneo->nombre) }}" autofocus>
                    ...
                    <select name="deporte_id" class="form-select @error('deporte_id') is-invalid @enderror">
                        ...
                        @foreach($deportes as $deporte)
                            <option value="{{ $deporte->id }}"
                                    @selected(old('deporte_id', $torneo->deporte_id) == $deporte->id)>
                                {{ $deporte->nombre }}
                            </option>
                        @endforeach
                    </select>
                    ...
                    <select name="creado_por" class="form-select @error('creado_por') is-invalid @enderror">
                        ...
                        @foreach($usuarios as $usuario)
                            <option value="{{ $usuario->id }}"
                                    @selected(old('creado_por', $torneo->creado_por) == $usuario->id)>
                                {{ $usuario->nombre }}
                            </option>
                        @endforeach
                    </select>
                ...
                <div class="col-sm-6">
                    ...
                    <select name="formato" class="form-select @error('formato') is-invalid @enderror">
                        @foreach($formatos as $valor => $etiqueta)
                            <option value="{{ $valor }}"
                                    @selected(old('formato', $torneo->formato) === $valor)>
                                {{ $etiqueta }}
                            </option>
                        @endforeach
                    </select>
                ...
                <div class="col-sm-6">
                    ...
                    <select name="estado" class="form-select @error('estado') is-invalid @enderror">
                        @foreach($estados as $valor => $etiqueta)
                            <option value="{{ $valor }}"
                                    @selected(old('estado', $torneo->estado) === $valor)>
                                {{ $etiqueta }}
                            </option>
                        @endforeach
                    </select>
                ...
                <div class="col-sm-4">
                    ...
                    <select name="max_jugadores" class="form-select @error('max_jugadores') is-invalid @enderror">
                        @foreach([4, 8, 16, 32, 64] as $n)
                            <option value="{{ $n }}"
                                    @selected(old('max_jugadores', $torneo->max_jugadores) == $n)>
                                {{ $n }}
                            </option>
                        @endforeach
                    </select>
                ...
                <div class="col-sm-4">
                    ...
                    <input type="number" name="elo_minimo"
                           ...
                           value="{{ old('elo_minimo', $torneo->elo_minimo) }}" min="0">
                ...
                <div class="col-sm-4">
                    ...
                    <input type="number" name="elo_maximo"
                           ...
                           value="{{ old('elo_maximo', $torneo->elo_maximo) }}" min="0">
                ...
                <div class="col-sm-6">
                    ...
                    <input type="datetime-local" name="fecha_inicio"
                           ...
                           value="{{ old('fecha_inicio', $torneo->fecha_inicio?->format('Y-m-d\TH:i')) }}" required>
                ...
                <div class="col-sm-6">
                    ...
                    <input type="datetime-local" name="fecha_fin"
                           ...
                           value="{{ old('fecha_fin', $torneo->fecha_fin?->format('Y-m-d\TH:i')) }}">
